...
public class DeviceControlStringTest extends TerminalTestCase {
  ...
  public void testReportColorsAndName() {
    ...
    // hexadecimal (2 digits per character) separated by ; which correspond to termcap or terminfo
    // key
    // names.
    ...
    // xterm responds with DCS 1 + r P t ST for valid requests, adding to P t an = , and the value
    // of the
  ...
  public void testReallyLongDeviceControlString() {
    ...
    // The terminal should ignore the overlong DCS sequence and continue printing "aaa." and fill at
    // least the first two lines with
    // them:
    assertLineIs(0, "aaa");
    assertLineIs(1, "aaa");
  }
