...
public class UnicodeInputTest extends TerminalTestCase {
  ...
  public void testIllFormedUtf8SuccessorByteNotConsumed() throws Exception {
    ...
    // first byte, but which does not
    // continue with valid successor bytes (see Table 3-7), it must not consume the successor bytes
    // as part of the ill-formed
    // subsequence whenever those successor bytes themselves constitute part of a well-formed UTF-8
    ...
    // https://bugzilla.mozilla.org/show_bug.cgi?id=746900: "with this patch 0xe0 0x80 is decoded as
    // two U+FFFDs,
