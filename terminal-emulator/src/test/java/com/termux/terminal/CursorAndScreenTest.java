...
public class CursorAndScreenTest extends TerminalTestCase {
  ...
  public void testCursorForward() {
    ...
    // If an attempt is made to move the cursor to the right of the right margin, the cursor stops
    // at the right margin:
  ...
  public void testCursorBack() {
    ...
    // If an attempt is made to move the cursor to the left of the left margin, the cursor stops at
    // the left margin:
  ...
  public void testCursorUp() {
    ...
    // If an attempt is made to move the cursor above the top margin, the cursor stops at the top
    // margin:
  ...
  public void testReportCursorPosition() {
    ...
    for (int i = 0; i < 10; i++) {
      for (int j = 0; j < 10; j++) {
        ...
        // DECXCPR — Extended Cursor Position. Note that http://www.vt100.net/docs/vt510-rm/DECXCPR
        // says
